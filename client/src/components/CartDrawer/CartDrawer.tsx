...
const CartDrawer: React.FC<CartDrawerProps> = ({ open, onClose }) => {
  ...
  return (
    <Drawer title="Varukorg:" onClose={onClose} open={open}>
      {items.length === 0 ? (
        <div className="empty-cart-message">Din varukorg är tom.</div>
      ) : (
        <div>
          {" "}
          {/* En omslutande div runt hela innehållet om det finns varor i varukorgen */}
          {items.map((item) => (
              ...
              <div className="titleAndPrice">
                ...
                <div className="quantity-control">
                  ...
                  <button
                    ...
                    onClick={() => cartContext.decreaseQuantity(item._id)}
                  >
                    -
                  </button>
                  ...
                  <button
                    className="circle-button"
                    onClick={() => cartContext.increaseQuantity(item._id)}
                  >
                    +
                  </button>
                </div>
            ...
            {isUserLoggedIn ? (
              ...
              <div>
                <div className="loginMessage">
                  Vänligen logga in för att fortsätta till kassan.
                </div>
